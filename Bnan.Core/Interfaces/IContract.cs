...
namespace Bnan.Core.Interfaces
{
    public interface IContract
    {
        ...
        Task<CrCasRenterContractBasic> AddRenterContractBasic(string LessorCode, string BranchCode, string BranchReceivingCode, string ContractNo, string RenterId, string sectorCodeForRenter, string DriverId, string PrivateDriver,
