...
namespace Bnan.Core.Interfaces
{
    public interface ICustody
    {
        ...
        Task<bool> AddAccountReceiptReceivedCustody(string AdmintritiveNo, string lessorCode, string BranchCode, string Creditor,string userCode,string SavePdfArReceipt,string SavePdfEnReceipt, string reasons);
