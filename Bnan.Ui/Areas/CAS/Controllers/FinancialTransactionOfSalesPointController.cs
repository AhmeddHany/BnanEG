...
namespace Bnan.Ui.Areas.CAS.Controllers
{
    ...
    public class FinancialTransactionOfSalesPointController : BaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var FinancialTransactionOfSalesPointAll = _unitOfWork.CrCasAccountReceipt.FindAll(x => currentUser.CrMasUserInformationLessor == x.CrCasAccountReceiptLessorCode && (x.CrCasAccountReceiptType == "301" || x.CrCasAccountReceiptType == "302"), new[] { "CrCasAccountReceiptSalesPointNavigation", "CrCasAccountReceiptNavigation", "CrCasAccountReceiptAccountNavigation", "CrCasAccountReceiptBankNavigation" }).Where(x=> x.CrCasAccountReceiptSalesPointNavigation?.CrCasAccountSalesPointNo != null).OrderByDescending(x => x.CrCasAccountReceiptDate).ToList();
