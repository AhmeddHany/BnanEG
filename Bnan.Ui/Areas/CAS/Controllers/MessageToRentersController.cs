...
namespace Bnan.Ui.Areas.CAS.Controllers
{
    ...
    [Area("CAS")]
    [Authorize(Roles = "CAS")]
    public class MessageToRentersController : BaseController
    {
        ...
        private readonly IStringLocalizer<MessageToRentersController> _localizer;
        private readonly IAdminstritiveProcedures _adminstritiveProcedures;


        public MessageToRentersController(UserManager<CrMasUserInformation> userManager, IUnitOfWork unitOfWork,
            IMapper mapper, IUserService userService,  IAdminstritiveProcedures AdminstritiveProcedures,
        IUserLoginsService userLoginsService, IToastNotification toastNotification, IWebHostEnvironment webHostEnvironment, IStringLocalizer<MessageToRentersController> localizer) : base(userManager, unitOfWork, mapper)
        {
