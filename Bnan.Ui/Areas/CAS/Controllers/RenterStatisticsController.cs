...
namespace Bnan.Ui.Areas.CAS.Controllers
{
    ...
    public class RenterStatisticsController : BaseController
    {
        ...
        public async Task<IActionResult> GetAllByType(string Type ,string listDrop ,string singleNo)
        {
            ...
            if (Type == "Age")
            {
                var AllRenters2_Age = _unitOfWork.CrCasRenterLessor.FindAll(x => currentCar.CrMasUserInformationLessor == x.CrCasRenterLessorCode ).DistinctBy(x => x.CrCasRenterLessorStatisticsAge).OrderBy(x => x.CrCasRenterLessorStatisticsAge).ToList();
                ...
                foreach (var single in AllRenters2_Age)
                {
                    ...
                    switch (single.CrCasRenterLessorStatisticsAge)
                    {
                        ...
                        case "3":
                            ...
                            break;
                        case "4":
                            chartBranchDataVM.ArName = "31 - 35";
                            chartBranchDataVM.EnName = "31 - 35";
                            break;
                        case "5":
                            chartBranchDataVM.ArName = "36 - 40";
            ...
            if (Type == "Traded")
            {
                var AllRenters2_Traded = _unitOfWork.CrCasRenterLessor.FindAll(x => currentCar.CrMasUserInformationLessor == x.CrCasRenterLessorCode).DistinctBy(x => x.CrCasRenterLessorStatisticsTraded).OrderBy(x => x.CrCasRenterLessorStatisticsTraded).ToList();
                ...
                foreach (var single in AllRenters2_Traded)
                {
                    ...
                    switch (single.CrCasRenterLessorStatisticsTraded)
                    {
                        case "1":
                            ...
                            break;
                        case "2":
                            chartBranchDataVM.ArName = "1001 - 2000";
                            chartBranchDataVM.EnName = "1001 - 2000";
                            break;
                        case "3":
                            ...
                            break;
                        case "4":
                            chartBranchDataVM.ArName = "3001 - 5000";
                            chartBranchDataVM.EnName = "3001 - 5000";
                            break;
                        case "5":
                            chartBranchDataVM.ArName = "5001 - 7000";
                            chartBranchDataVM.EnName = "5001 - 7000";
                            break;
                        case "6":
                            chartBranchDataVM.ArName = "7001 - 10,000";
                            chartBranchDataVM.EnName = "7001 - 10,000";
                            break;
                        case "7":
                            chartBranchDataVM.ArName = "10,001 - 15,000";
                            chartBranchDataVM.EnName = "10,001 - 15,000";
                            break;
                        case "8":
                            chartBranchDataVM.ArName = "15,001 - 20,000";
                            chartBranchDataVM.EnName = "15,001 - 20,000";
                            break;
                        case "9":
            ...
            {                
                var AllDealing_Mechanism = _unitOfWork.CrMasSysEvaluation.FindAll(x => x.CrMasSysEvaluationsStatus != Status.Deleted && Convert.ToInt16(x.CrMasSysEvaluationsCode.Trim()) < 16).ToList();
            ...
            if (Type == "Traded" || Type == "Age" || Type== "Status" || Type == "Dealing_Mechanism")
            {
