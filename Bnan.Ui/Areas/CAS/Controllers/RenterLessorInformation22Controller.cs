...
namespace Bnan.Ui.Areas.CAS.Controllers
{
    ...
    [Area("CAS")]
    [Authorize(Roles = "CAS")]
    public class RenterLessorInformation22Controller : BaseController
    {
        ...
        private readonly IRenterLessorInformation _RenterLessorInformation22;
        private readonly IToastNotification _toastNotification;
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly IStringLocalizer<RenterLessorInformation22Controller> _localizer;
        private readonly IAdminstritiveProcedures _adminstritiveProcedures;


        public RenterLessorInformation22Controller(UserManager<CrMasUserInformation> userManager, IUnitOfWork unitOfWork,
            IMapper mapper, IUserService userService, IRenterLessorInformation RenterLessorInformation22, IAdminstritiveProcedures AdminstritiveProcedures,
        IUserLoginsService userLoginsService, IToastNotification toastNotification, IWebHostEnvironment webHostEnvironment, IStringLocalizer<RenterLessorInformation22Controller> localizer) : base(userManager, unitOfWork, mapper)
        {
            this.userManager = userManager;
            this.unitOfWork = unitOfWork;
            this.mapper = mapper;
            _userService = userService;
            _RenterLessorInformation22 = RenterLessorInformation22;
        ...
        public async Task<IActionResult> Index()
        {
           ...
           subTask.CrMasSysSubTasksEnName, system.CrMasSysSystemCode, system.CrMasSysSystemArName, system.CrMasSysSystemEnName);
            ...
            return View(RenterLessorInformation22All);
        }

        [HttpGet]
        public async Task<PartialViewResult> GetRenterLessorInformation22ByStatusAsync(string status)
        {
            ...
            if (!string.IsNullOrEmpty(status))
            {
                ...
                {
                    var RenterLessorInformation22byStatusAll = _unitOfWork.CrCasRenterLessor.FindAll(l => (l.CrCasRenterLessorStatus == Status.Active || l.CrCasRenterLessorStatus == Status.Rented) && l.CrCasRenterLessorCode == currentUser.CrMasUserInformationLessor, new[] { "CrCasRenterLessorNavigation.CrMasRenterPost", "CrCasRenterLessorStatisticsJobsNavigation", "CrCasRenterLessorStatisticsNationalitiesNavigation" }).ToList();
                    return PartialView("_DataTableRenterLessorInformation22", RenterLessorInformation22byStatusAll);
                }
                var RenterLessorInformation22byStatus = _unitOfWork.CrCasRenterLessor.FindAll(l => l.CrCasRenterLessorStatus == status && l.CrCasRenterLessorCode == currentUser.CrMasUserInformationLessor, new[] { "CrCasRenterLessorNavigation.CrMasRenterPost", "CrCasRenterLessorStatisticsJobsNavigation", "CrCasRenterLessorStatisticsNationalitiesNavigation" }).ToList();
                return PartialView("_DataTableRenterLessorInformation22", RenterLessorInformation22byStatus);
            }
            return PartialView();
        }
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            int countRenterLessorInformation22s = 0;
            ViewBag.RenterLessorInformation22s_Count = countRenterLessorInformation22s;
        ...
        public async Task<IActionResult> Edit(RenterLessorInformationVM model)
        {
            ...
            return RedirectToAction("Index", "RenterLessorInformation22");
        }
        ...
        public async Task<IActionResult> FailedMessageReport_NoData()
        {
            ...
            //var RenterLessorInformation22All = _unitOfWork.CrCasRenterLessor.FindAll(x => x.CrCasRenterLessorCode == currentUser.CrMasUserInformationLessor, new[] { "CrCasRenterLessorNavigation.CrMasRenterPost" }).ToList();
