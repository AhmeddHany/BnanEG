...
namespace Bnan.Ui.Areas.MAS.Controllers
{
    ...
    public class ContractStatistics22Controller : BaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var AllContracts = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => Most_Frequance_Company == x.CrCasRenterContractStatisticsLessor).OrderByDescending(x => x.CrCasRenterContractStatisticsDate).ToList();
            ...
            var Branch_count = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor).DistinctBy(x => x.CrCasRenterContractStatisticsBranch).Count();
            var Day_Create_count = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor).DistinctBy(x => x.CrCasRenterContractStatisticsDayCreate).Count();
            var Time_Create_count = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor).DistinctBy(x => x.CrCasRenterContractStatisticsTimeCreate).Count();
            var Day_count = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor).DistinctBy(x => x.CrCasRenterContractStatisticsDayCount).Count();
            var Value_Contract_count = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor).DistinctBy(x => x.CrCasRenterContractStatisticsValueNo).Count();
            var KM_count = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor).DistinctBy(x => x.CrCasRenterContractStatisticsKm).Count();
            var Days_count = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor).DistinctBy(x => x.CrCasRenterContractStatisicsDays).Count();
        ...
        public async Task<IActionResult> GetAllByType(string Type, string listDrop, string singleNo, string startDate, string endDate , string company_now)
        {
            ...
            var AllContracts = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor && x.CrCasRenterContractStatisticsDate < _max && x.CrCasRenterContractStatisticsDate >= _mini).ToList();
            ...
            if (Type == "Branch")
            {
                var AllBranches = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor, new[] { "CrCasRenterContractStatistics" }).Where(x => x.CrCasRenterContractStatistics?.CrCasBranchInformationStatus != Status.Deleted).DistinctBy(x => x.CrCasRenterContractStatisticsBranch).ToList();
            ...
            if (Type == "Day_Create")
            {
                var AllContracts2_Day_Create = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor).DistinctBy(x => x.CrCasRenterContractStatisticsDayCreate).ToList();
            ...
            if (Type == "Time_Create")
            {
                var AllContracts2_Time_Create = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor).DistinctBy(x => x.CrCasRenterContractStatisticsTimeCreate).ToList();
            ...
            if (Type == "Day_Count")
            {
                var AllContracts2_Day_Count = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor).DistinctBy(x => x.CrCasRenterContractStatisticsDayCount).ToList();
            ...
            if (Type == "Value_No")
            {
                var AllContracts2_Contract_Value = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor).DistinctBy(x => x.CrCasRenterContractStatisticsValueNo).ToList();
            ...
            if (Type == "KM")
            {
                var AllContracts2_KM = _unitOfWork.CrCasRenterContractStatistic.FindAll(x => company == x.CrCasRenterContractStatisticsLessor).DistinctBy(x => x.CrCasRenterContractStatisticsKm).ToList();
