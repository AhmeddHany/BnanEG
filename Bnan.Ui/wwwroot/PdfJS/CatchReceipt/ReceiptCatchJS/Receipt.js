...
//    // تحميل الصور الأساسية المطلوبة
//    const [backgroundImg, signatureImg, qrImg, stampImg] = await Promise.all([
//        loadImage("PdfJS/images/Receipt Voucher.png"),
//        loadImage("PdfJS/images/signature_08.png"),
//        loadImage("PdfJS/images/verificationT.svg"),
//        loadImage("PdfJS/images/Stamp.png"),
//    ]);
...
//            { key: "DATE_AR", x: canvas.width - 210, y: 605, align: "right" },
//            { key: "DATE_EN", x: canvas.width - 232, y: 675, align: "right" },
//            { key: "HIJRI_DATE_EN", x: canvas.width - 1525, y: 605, align: "left" },
//            { key: "CONTRACT_NUMBER", x: canvas.width - 2400, y: 605, align: "left" },
//            { key: "AMOUNT", x: canvas.width - 2350, y: 690, align: "left" },
//            { key: "HALALAS", x: canvas.width - 2040, y: 690, align: "left" },
//            { key: "TENANT_NAME_AR", x: canvas.width - 200, y: 795, align: "right" },
...
//        ],
//        images: [
//            { content: signatureImg, x: canvas.width - 957, y: 1519, width: 240, height: 105 },
//            { content: qrImg, x: canvas.width - 2411, y: 1447, width: 200, height: 200 },
//            { content: stampImg, x: canvas.width - 1076, y: 1475, width: 204, height: 160 },
//        ],
//        textStyle: {
//            fontWeight: "normal",
//            fontSize: 46,
...
//            // مدخلات لتخزين الملف  و رقم السند
//            document.getElementById(InputPdf).value = pdfBase64;
//            document.getElementById(InputHaveNo).value = PdfNo;
//            console.log("pdfBase64", pdfBase64);
//            console.log("PdfNo", PdfNo);
