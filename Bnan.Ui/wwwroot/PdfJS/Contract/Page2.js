...
const fixedConfig = {
  texts: [
    ...
    { key: "DRIVER_NAME_EN", x: canvas.width - 420, y: 990, color: "#0D5485", fontSize: 45, fontWeight: "600", align: "right" },
    ...
    { key: "ADDITIONAL_DRIVER_NAME_EN", x: canvas.width - 420, y: 1700, color: "#0D5485", fontSize: 45, fontWeight: "600" , align: "right"},
    { key: "ADDITIONAL_DRIVER_ID", x: canvas.width - 518, y: 1797 , align: "right"},
    { key: "ADDITIONAL_DRIVER_NATIONALITY_AR", x: canvas.width - 1167, y: 1785, fontSize: 40 , align: "right" },
    { key: "ADDITIONAL_DRIVER_NATIONALITY_EN", x: canvas.width - 1167, y: 1825 , align: "right" },
    ...
    { key: "ADDITIONAL_DRIVER_NATIONALITY_2_AR", x: canvas.width - 1782, y: 1885, fontSize: 40 , align: "right"},
    { key: "ADDITIONAL_DRIVER_NATIONALITY_2_EN", x: canvas.width - 1782, y: 1920 , align: "right"},
    ...
    { key: "PRIVATE_DRIVER_NAME_EN", x: canvas.width - 420, y: 2420, color: "#0D5485", fontSize: 45, fontWeight: "600", align: "right" },
