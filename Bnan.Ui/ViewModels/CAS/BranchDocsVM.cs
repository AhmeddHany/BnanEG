...
{
    public class BranchDocsVM
    {
        public string? CrCasBranchDocumentsLessor { get; set; }
        public string? CrCasBranchDocumentsBranch { get; set; }
        public string? CrCasBranchDocumentsProcedures { get; set; }
